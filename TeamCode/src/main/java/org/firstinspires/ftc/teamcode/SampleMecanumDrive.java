...
import org.firstinspires.ftc.teamcode.TrajectorySequenceBuilder;
import org.firstinspires.ftc.teamcode.TrajectorySequenceRunner;
...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(4.5, 0, 1e-8);//Kd could be the issue for spinning
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftRear.setDirection(DcMotorSimple.Direction.FORWARD);                 //setting direction of drive train
